...
_FEDORA_RELEASE = "42"
_REPO_BASE_URL = "https://download.fedoraproject.org/pub/fedora/linux/releases/42/Everything"
...
def _fedora_gcc_toolchain_impl(repository_ctx):
    ...
    print("Setting up Fedora {} GCC toolchain for {}".format(_FEDORA_RELEASE, rpm_arch))
    ...
    setup_args = ["bash", "-c", "exec ./setup_toolchain.sh 'fedora' '{}' '{}' {}".format(
        "{}/os".format(repo_url),
        rpm_arch,
